...
dwg = svgwrite.Drawing('/Volumes/africa/export/naturalearth/region/land/trmm/0/ne-110m-land_land_trmm_0_2.svg', profile='tiny')
...
def main():
    svg = InkscapeDrawing('/Volumes/africa/export/naturalearth/region/land/trmm/0/ne-110m-land_land_trmm_0_3.svg', profile='full', size=(640, 480))
